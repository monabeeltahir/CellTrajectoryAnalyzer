...
if __name__ == "__main__":
    ...
    datapath = ['C:/Users/mt1102/Box/Nabeel Tahir Meetings/Meetings/Weekly Meetings/Meeting June 2026/Experiment 6_10_2026/Sample 2/Stained/', 
                'C:/Users/mt1102/Box/Nabeel Tahir Meetings/Meetings/Weekly Meetings/Meeting June 2026/Experiment 6_10_2026/Sample 2/Unstained/']
    ...
    for i in range(2):
        ...
        for  videofilename in videofillist:
            ...
            do_tilt_correction=do_tilt_correction,   save_corrected_plot=True,  # IMPORTANT
            tilt_method=tilt_method,
    ...
    for vids in videofillist:
        ...
        #print(df.columns)
        DefAnalysis_Dynamic(ExperimentFile= expervidpath[:-4]+"/"+f"filtered_trajectories.csv",  
                            ControlFile = contrlvidpath[:-4]+"/"+f"filtered_trajectories.csv", OutputFolder=expervidpath[:-4], 
                            min_track_length = 40, sensitivity=99, correct_baseline_drift=False, fit_exponential_exp=False,
                    exp_min_x_span_px=40, CntrlOutputFolder= contrlvidpath[:-4], TiltType=tilt_method)
